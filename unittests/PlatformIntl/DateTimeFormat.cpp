...
TEST(DateTimeFormat, DatesWithHourMinuteSecondOptions) {
  ...
  auto dtf = platform_intl::DateTimeFormat();
  dtf.initialize(*runtime.get(), AmericanEnglish, testOptions);
  auto result = dtf.format(1620000303000);
  ...
  auto result2 = dtf2.format(1620000303000);
  ...
  auto result3 = dtf3.format(1620000303000);
  EXPECT_EQ(result3, u"05");

  Options testOptions4 = {{u"hour", Option(std::u16string(u"2-digit"))}};
  auto dtf4 = platform_intl::DateTimeFormat();
  dtf4.initialize(*runtime.get(), AmericanEnglish, testOptions4);
  auto result4 = dtf4.format(1620000303000);
  ...
  Options testOptions5 = {
      ...
      {u"second", Option(std::u16string(u"numeric"))}};
  auto dtf5 = platform_intl::DateTimeFormat();
  dtf5.initialize(*runtime.get(), AmericanEnglish, testOptions5);
  auto result5 = dtf5.format(1620000303000);
...
TEST(DateTimeFormat, DatesWithHourCyclesOptions) {
  ...
  auto dtf = platform_intl::DateTimeFormat();
  dtf.initialize(*runtime.get(), AmericanEnglish, testOptions);
  auto result = dtf.format(1620008000000);
...
TEST(DateTimeFormat, DatesWithAllOptions) {
  ...
  auto dtf = platform_intl::DateTimeFormat();
  dtf.initialize(*runtime.get(), AmericanEnglish, testOptions);
  auto result = dtf.format(1620008000000.00);
  EXPECT_EQ(
      result,
  ...
  auto dtf2 = platform_intl::DateTimeFormat();
  dtf2.initialize(*runtime.get(), AmericanEnglish, testOptions2);
  auto result2 = dtf2.format(1620008000000.00);
