...
TEST(DateTimeFormat, DatesWithoutOptions) {
  ...
  auto dtf = platform_intl::DateTimeFormat::create(*runtime.get(), AmericanEnglish, testOptions);
  ...
  auto dtf2 = platform_intl::DateTimeFormat::create(*runtime.get(), KoreanKorea, testOptions);
  auto result2 = dtf2.getValue().get()->format(1620000000000.00);
  EXPECT_EQ(result2, u"2021. 5. 2.");

  auto dtf3 = platform_intl::DateTimeFormat::create(*runtime.get(), french, testOptions);
...
TEST(DateTimeFormat, DatesWithTimeDateStyles) {
  ...
  auto dtf2 = platform_intl::DateTimeFormat::create(*runtime.get(), french, testOptions);
  auto result2 = dtf2.getValue().get()->format(1620000000000.00);
  EXPECT_EQ(
      result2,
      u"dimanche 2 mai 2021 \u00E0 17:00:00 heure d\u2019\u00E9t\u00E9 du Pacifique"); // L"dimanche 2 mai 2021 à 17:00:00 heure d’été du Pacifique"

  auto dtf3 = platform_intl::DateTimeFormat::create(*runtime.get(), SpanishPeru, testOptions);
  ...
  auto dtf4 = platform_intl::DateTimeFormat::create(*runtime.get(), AmericanEnglish, testOptions2);
  auto result4 = dtf4.getValue().get()->format(1620000000000.00);
  EXPECT_EQ(result4, u"5/2/21, 5:00 PM");

  auto dtf5 = platform_intl::DateTimeFormat::create(*runtime.get(), french, testOptions2);
  auto result5 = dtf5.getValue().get()->format(1620000000000.00);
  EXPECT_EQ(result5, u"02/05/2021 17:00");

  auto dtf6 = platform_intl::DateTimeFormat::create(*runtime.get(), SpanishPeru, testOptions2);
  ...
  auto dtf7 = platform_intl::DateTimeFormat::create(*runtime.get(), AmericanEnglish, testOptions3);
  auto result7 = dtf7.getValue().get()->format(1620000000000.00);
  EXPECT_EQ(result7, u"May 2, 2021 at 5:00:00 PM");

  auto dtf8 = platform_intl::DateTimeFormat::create(*runtime.get(), french, testOptions3);
  auto result8 = dtf8.getValue().get()->format(1620000000000.00);
  EXPECT_EQ(result8, u"2 mai 2021 \u00E0 17:00:00"); // L"2 mai 2021 à 17:00:00"

  auto dtf9 = platform_intl::DateTimeFormat::create(*runtime.get(), SpanishPeru, testOptions3);
...
TEST(DateTimeFormat, DatesWithMonthDayYearOptions) {
  ...
  auto dtf = platform_intl::DateTimeFormat::create(*runtime.get(), DutchBelgium, testOptions);
  auto result = dtf.getValue().get()->format(1620000000000.00);
  ...
  auto dtf2 = platform_intl::DateTimeFormat::create(*runtime.get(), DutchBelgium, testOptions2);
  auto result2 = dtf2.getValue().get()->format(1620000000000.00);
  ...
  Options testOptions3 = {
      ...
      {u"year", Option(std::u16string(u"2-digit"))}};
  auto dtf3 = platform_intl::DateTimeFormat::create(*runtime.get(), DutchBelgium, testOptions3);
  auto result3 = dtf3.getValue().get()->format(1620000000000.00);
...
TEST(DateTimeFormat, DatesWithWeekdayEraTimeZoneNameOptions) {
  ...
  auto dtf = platform_intl::DateTimeFormat::create(*runtime.get(), ItalianItaly, testOptions);
  auto result = dtf.getValue().get()->format(1620000000000.00);
  ...
  auto dtf2 = platform_intl::DateTimeFormat::create(*runtime.get(), ItalianItaly, testOptions2);
  auto result2 = dtf2.getValue().get()->format(1620000000000.00);
  ...
  auto dtf3 = platform_intl::DateTimeFormat::create(*runtime.get(), ItalianItaly, testOptions3);
  auto result3 = dtf3.getValue().get()->format(1620000000000.00);
...
TEST(DateTimeFormat, DatesWithHourMinuteSecondOptions) {
  ...
  auto dtf2 = platform_intl::DateTimeFormat::create(*runtime.get(), AmericanEnglish, testOptions2);
  ...
  auto dtf3 = platform_intl::DateTimeFormat::create(*runtime.get(), AmericanEnglish, testOptions3);
  ...
  auto dtf4 = platform_intl::DateTimeFormat::create(*runtime.get(), AmericanEnglish, testOptions4);
  ...
  Options testOptions5 = {
      {u"hour", Option(std::u16string(u"2-digit"))},
      {u"second", Option(std::u16string(u"numeric"))}};
  auto dtf5 = platform_intl::DateTimeFormat::create(*runtime.get(), AmericanEnglish, testOptions5);
