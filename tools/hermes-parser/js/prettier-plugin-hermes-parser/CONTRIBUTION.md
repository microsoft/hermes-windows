...
3. Run `hermes-parser/js$ node ../../../.yarn/releases/yarn-4.13.0.cjs build-prettier` after making any changes.
...
2. Build repo: `node .yarn/releases/yarn-4.9.2.cjs build --package=@prettier/plugin-hermes`
